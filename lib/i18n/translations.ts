...
export const t: Translations = {
  ...
  ru: {
    ...
    team: [
      { id: "chemical-expert", name: "Д-р [Имя]", role: "Главный химик-инженер", bio: "Государственный эксперт с десятилетиями опыта в разработке рецептур и международных исследованиях. Руководит разработкой, тестированием и сертификацией.", credentials: ["Руководство в национальном химрегулировании", "Международное сотрудничество", "Десятилетия в разработке рецептур", "Авторитет в госстандартах качества"] },
      { id: "founder", name: "Мансур", role: "Основатель и директор", bio: "Построил Marshall с нуля с 2022 года. Развитие бизнеса, отношения с клиентами, стратегия. Глубокое понимание рынка смазочных материалов Центральной Азии.", credentials: ["Основал Marshall в 2022", "Выстроил 15+ B2B-отношений", "Опыт розницы и каналов сбыта", "Развитие рынка Сурхандарьи"] },
    ],
    clients: {
    ...
    team: [
      {
        ...
        bio: "Retseptura ishlab chiqish, sifat nazorati va xalqaro hamkorlikda o'nlab yillik tajribaga ega yuqori martabali davlat kimyoviy mutaxassisi. Barcha mahsulot ishlab chiqish, sinov va sertifikatsiya ishlariga rahbarlik qiladi. Eron va Markaziy Osiyodagi kimyoviy ekspertlar bilan qo'shma tajribalar o'tkazgan.",
        credentials: [
          "Milliy kimyoviy tartibga solish rahbariyati",
          "Xalqaro hamkorlik tajribasi",
          "O'nlab yillik retseptura ekspertizasi",
          "Davlat sifat standartlari vakolati",
        ],
      },
      {
        id: "founder",
        ...
        bio: "2022 yildan boshlab Marshallni noldan qurdi. Biznesni rivojlantirish, mijozlar bilan munosabatlar va strategik yo'nalishni boshqaradi. Markaziy Osiyo moylash materiallari bozori va uning o'sish trayektoriyasini chuqur tushunadi.",
        credentials: [
          "2022 yilda Marshallga asos soldi",
