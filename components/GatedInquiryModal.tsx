        ...
        {submitted ? (
          <div style={{ textAlign: "center", padding: "2rem 0" }}>
            ...
            <p style={{ color: "var(--shell-gray)", fontSize: "1.125rem", lineHeight: 1.6 }}>
              We will respond within 24 hours with the next steps.
            </p>
          </div>
        ) : (
          <>
            ...
            <h2 className="modal__title" style={{ fontSize: "2.5rem", marginBottom: "1rem", color: "var(--shell-black)", lineHeight: 1.1 }}>Direct Inquiry</h2>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
              <div className="form-group">
                <label className="form-label" style={{ color: "var(--shell-black)", fontWeight: 700, marginBottom: "0.5rem" }}>Full Name</label>
              ...
              <div className="form-group">
                <label className="form-label" style={{ color: "var(--shell-black)", fontWeight: 700, marginBottom: "0.5rem" }}>Professional Email</label>
              ...
              <div className="form-group">
                <label className="form-label" style={{ color: "var(--shell-black)", fontWeight: 700, marginBottom: "0.5rem" }}>Investment Range (USD)</label>
